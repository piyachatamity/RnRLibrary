package com.amityeko.rnr.common.components.expandablerecyclerview;
...
import com.amityeko.rnr.common.components.expandablerecyclerview.model.ExpandableWrapper;
import com.amityeko.rnr.common.components.expandablerecyclerview.model.Parent;
...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
     ...
     * <p>
     * Should be called from onSaveInstanceState(Bundle)} in
     ...
     * <p>
     * Should be called from onRestoreInstanceState(Bundle) in
     * the {@link Activity} that hosts the RecyclerView that this
     * {@link ExpandableRecyclerAdapter} is attached to.
     * <p>
